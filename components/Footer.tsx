...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-charcoal pt-16 sm:pt-24 md:pt-32 pb-8 sm:pb-12 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-[1920px] mx-auto">
        
        {/* Giant Luxury Text Section */}
        <div className="relative py-8 sm:py-12 md:py-24 border-b border-cream/5 mb-12 sm:mb-24 overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 w-full text-center">
                ...
                <div className="flex justify-center items-center gap-6 mb-8 opacity-60">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-sans text-[8px] sm:text-[10px] md:text-xs uppercase tracking-[0.2em] sm:tracking-[0.4em] text-cream">The Apex of Taste</span>
                        <Star className="w-3 h-3 text-rust fill-rust" />
                    </div>
                ...
                <div className="relative inline-block group cursor-default">
                    {/* Main Gradient Text */}
                    <h1 className="font-display text-[15vw] sm:text-[13vw] leading-[0.8] tracking-tight uppercase text-center relative z-10 transition-transform duration-1000 ease-out group-hover:scale-105">
                    ...
                    <h1 className="absolute top-0 left-0 w-full font-display text-[15vw] sm:text-[13vw] leading-[0.8] tracking-tight uppercase text-center pointer-events-none z-0 opacity-30 blur-[1px]" style={{ WebkitTextStroke: '1px #8c3a28', color: 'transparent' }}>
                         Sky Dine
                    </h1>
                    
                    {/* Shadow Layer */}
                    <h1 className="absolute top-4 left-0 w-full font-display text-[15vw] sm:text-[13vw] leading-[0.8] tracking-tight uppercase text-center pointer-events-none z-0 text-void opacity-50 blur-sm mix-blend-multiply">
                         Sky Dine
                    </h1>
                </div>
                ...
                <div className="mt-8 sm:mt-12 flex justify-center">
                    <Link to="/contact" className="group relative w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-full border border-cream/10 flex items-center justify-center backdrop-blur-sm hover:border-rust/50 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 md:gap-24 mb-16 sm:mb-32 relative z-10">
          ...
          <div className="md:col-span-1">
             ...
             <div className="flex flex-col gap-2">
               {RESTAURANT_INFO.phone.map((ph, i) => (
                 <a key={i} href={`tel:${ph}`} className="interactive font-display text-xl sm:text-2xl text-cream hover:text-rust transition-colors">{ph}</a>
               ))}
             </div>
          </div>
